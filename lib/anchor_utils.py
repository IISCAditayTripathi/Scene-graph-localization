    ...
    def set_cell_anchors(self, dtype: torch.dtype, device: torch.device):
        if self.cell_anchors is not None:
            ...
            if cell_anchors[0].device == device:
                return
        # print(self.sizes, self.aspect_ratios)
        # self.sizes = ((32,64,128,256,512))      # To be commented for FPN
        # self.aspect_ratios = ((0.5, 1.0, 2.0))  # To be commented for FPN
        cell_anchors = [
